    ...
    def one_epoch_test(self, testloader=None, current_epoch=None):
        ...
        if acc > best_acc:
            ...
            if self.batch_norm == True :
                torch.save(state, './checkpoint/ckpt_imbalanced_vgg16_bn.pth')
            else :
                torch.save(state, './checkpoint/ckpt_imbalanced_vgg16.pth')
    ...
    def one_epoch_test(self, testloader=None, current_epoch=None):
        ...
        if acc > best_acc:
            ...
            if self.batch_norm == True:
                ...
                torch.save(state, './checkpoint/ckpt_vgg16_balanced.pth')
            best_acc = acc
