...
from models.models_resnet_imagenet import *
from models.models_resnet_cifar import *
...
class imbalanced_Res32() :
    def __init__(self, trainset=None, testset=None, lr=None, imbalance_ratio=None,mu=None) :
        ...
        #self.net = PreResNet(34,100).cuda()
        self.net = resnet32().cuda()
    ...
    def one_epoch_test(self, testloader=None, current_epoch=None):
        ...
        if acc > best_acc:
            ...
            torch.save(state, './checkpoint/ckpt_imbalanced_res32_{}_{}.pth'.format(self.imbalance_ratio, self.mu))
            best_acc = acc
    ...
    def run(self, epochs):
        ...
        self.scheduler = optim.lr_scheduler.MultiStepLR(optimizer=self.optimizer, milestones=[70, 90], gamma=0.1)
...
class imbalanced_Res32_10() :
    def __init__(self, trainset=None, testset=None, lr=None, imbalance_ratio=None,mu=None) :
        ...
        set_seed(2020)
        #self.net = PreResNet(34,100).cuda()
        self.net = models.models_resnet_cifar.resnet32_10().cuda()
    ...
    def one_epoch_test(self, testloader=None, current_epoch=None):
        ...
        if acc > best_acc:
            ...
            torch.save(state, './checkpoint/ckpt_cifar10_imbalanced_res32_{}_{}.pth'.format(self.imbalance_ratio, self.mu))
            best_acc = acc
...
class balanced_Res32_10():
    ...
    def one_epoch_test(self, testloader=None, current_epoch=None):
        ...
        if acc > best_acc:
            ...
            torch.save(state, './checkpoint/ckpt_cifar10_balanced_res32.pth')
